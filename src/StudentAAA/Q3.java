...
public class Q3 extends Application {
    ...
    public void start(Stage primaryStage) {
     ...
     ((VBox)p2).setAlignment(Pos.CENTER);
      ...
      p2.setStyle("-fx-background-color:gold");
     ...
     btn1.setStyle("-fx-text-fill: white; -fx-background-color: orange;");
     Button btn2=new Button("Resite");
     btn2.setStyle("-fx-text-fill: white; -fx-background-color: blue;");
     Button btn3=new Button("Exite");
     btn3.setStyle("-fx-text-fill: white; -fx-background-color: purple;");
     ...
     HBox h2=new HBox(4,btn1,btn2,btn3);
       h2.setAlignment(Pos.CENTER);
        ...
        h.setStyle("-fx-background-color:pink;-fx-padding: 70px");
